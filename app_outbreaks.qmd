---
title: "Pandemic- and epidemic-prone disease outbreaks in the world: 1996-2025"
format:
  dashboard:
    theme: lux
    scrolling: false 
...
div(
  ...
  div(
    HTML('&#169; 2026 <a href="https://jatorresmunguia.github.io/disease-outbreaks-data.github.io/" target="_blank">Disease Outbreaks Data project</a>. 
...
output$value_time <- renderText({
  ...
  number_outbreaks_to_render <- paste0(
    Year_number_outbreaks() |>
      filter(Year == input$year_to_plot) |>
      pull(outbreaks)
  )

  number_outbreaks_to_render
